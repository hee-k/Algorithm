...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        double totalScroe = 0;  // sum(학점)
        double sum = 0;         // sum(학점 * 과목평점)
        ...
        for (int i = 0; i < 20; i++) {
            ...
            double score = Double.parseDouble(st.nextToken());  // 학점(4.5, 4.0, ...)
            String grade = st.nextToken();                      // 등급(A+, A, ...)
        ...
        System.out.println(sum / totalScroe);
    }
}